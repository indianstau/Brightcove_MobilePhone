...
//    BCOVCuePointProgressPolicy *policy = [BCOVCuePointProgressPolicy                          progressPolicyProcessingCuePoints:BCOVProgressPolicyProcessFinalCuePoint resumingPlaybackFrom:BCOVProgressPolicyResumeFromContentPlayhead ignoringPreviouslyProcessedCuePoints:NO];
   ...
   BCOVIMAAdsRequestPolicy * adsRequestPolicy = [BCOVIMAAdsRequestPolicy adsRequestPolicyFromCuePointPropertiesWithAdTag:kVIEWControllerIMAVASTResponseAdTag adsCuePointProgressPolicy:nil];
...
//        NSDictionary *adProperties = @{ kBCOVIMAAdTag : kVIEWControllerIMAVASTResponseAdTag };
//
...
//                                       position:CMTimeMake(10,1)
//                                     properties:@{ kBCOVIMAAdTag : @"https://pubads.g.doubleclick.net/gampad/ads?sz=640x480&iu=/124319096/external/single_ad_samples&ciu_szs=300x250&impl=s&gdfp_req=1&env=vp&output=vast&unviewed_position_start=1&cust_params=deployment%3Ddevsite%26sample_ct%3Dskippablelinear&correlator=" }],
//             ]];
//            }];
...
//                 BCOVCuePoint *cp1 = [[BCOVCuePoint alloc] initWithType:@"ad" position:CMTimeMake(duration * 250, 1000)];
//                 BCOVCuePoint *cp2 = [[BCOVCuePoint alloc] initWithType:@"ad" position:CMTimeMake(duration * 500, 1000)];
//                 BCOVCuePoint *cp3 = [[BCOVCuePoint alloc] initWithType:@"ad" position:CMTimeMake(duration * 750, 1000)];
//                 BCOVCuePoint *cp4 = [[BCOVCuePoint alloc] initWithType:@"ad" position:CMTimeMake(duration * 1000, 1000)];
//
